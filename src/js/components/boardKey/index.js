...
export default function BoardKey(props) {
  ...
  return <div class="board-key">
    ...
    <ul>
      ...
      <li class="eevp"><span>76% in</span> {hasEEVP ? <a href="https://www.ap.org/en-us/topics/politics/elections/counting-the-vote">Estimated expected vote</a> : "Precincts reporting"}</li>
